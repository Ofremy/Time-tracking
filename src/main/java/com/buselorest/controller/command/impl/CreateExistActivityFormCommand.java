...
public class CreateExistActivityFormCommand implements Command {
    private ServiceFactory serviceFactory;
    private DBConnectionPool pool;
    private final static Logger logger = Logger.getLogger(CreateExistActivityFormCommand.class);

    public CreateExistActivityFormCommand(ServiceFactory serviceFactory, DBConnectionPool pool) {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection connection = pool.getConnection()) {
            ...
            request.setAttribute("activity", activityService.getAll(connection));
        ...
        return PageConstants.CREATE_EXIST_ACTIVITY_FORM;
    }
}
